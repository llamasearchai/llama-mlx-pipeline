# Contributing to Llama Mlx Pipeline

Thank you for your interest in contributing to Llama Mlx Pipeline! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Mlx Pipeline:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-mlx-pipeline.git
   cd llama-mlx-pipeline
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-mlx-pipeline.git
   ```
...
By contributing to Llama Mlx Pipeline, you agree that your contributions will be licensed under the project's MIT License.
